...
const perguntas = [
    {
      pergunta: "O que a O&M da Solar 4.0 oferece?",
      resposta: "Nós oferecemos um serviço completo de operação e manutenção do seu sistema fotovoltaico. Desde limpeza das placas solares, até o monitoramento da geração de energia que o seu sistema produz.",
    },
    {
      pergunta: "Como tenho acesso a um orçamento personalizado?",
      resposta: "Entrando em contato conosco, nós precisaremos apenas de algumas informações já te enviaremos um orçamento gratuito, personalizado, que atenda às suas necessidades e objetivos.",
    },
    {
      pergunta: "Por que devo solicitar o serviço de Operação e Manutenção da Solar 4.0?",
      resposta: "O serviço de operação e manutenção do sistema solar deve ser acionado conforme a necessidade de conservação, a fim de proporcionar máxima eficiência dos módulos.",
    },
    {
      pergunta: "A O&M da Solar 4.0 atende qualquer marca de inversor e módulos?",
      resposta: "Sim! Nossas instalações são feitas com produtos Intelbras, mas atendemos qualquer sistema fotovoltaico, independente da marca de fabricação.",
    },
    {
...
export default function OPM() {
    ...
    return (
        <>
         <Header2 />
            <StyledOPM mostrarRespostas={perguntaAtiva !== null} className={scrollY > 100 ? 'rolagem' : ''}>
                <div id="container">
