                ...
                >
                    ...
                    <SwiperSlide>
                        <div className="box-depoimento">
                            ...
                            <div className="cx-img">
                                <img className="pessoas" src="https://lh3.googleusercontent.com/a/ACg8ocKb8-imfmxl5HlXUuxmEIq2_oJgnSOUcWtZqQJg53i-=w75-h75-p-rp-mo-br100" alt="foto" />
                                <h3>Andreia Castro</h3>
                            </div>
                    ...
                    <SwiperSlide>
                        <div className="box-depoimento">
                            ...
                            <div className="cx-img">
                                <img className="pessoas" src="https://lh3.googleusercontent.com/a-/ALV-UjWBykHkhKHVMVVHpxLJw2hW_ApQtvYtMMLtDwaKZmgrg1Ds=w75-h75-p-rp-mo-br100" alt="foto" />
                                <h3>Zilma Reis</h3>
                            </div>
                    ...
                    <SwiperSlide>
                        <div className="box-depoimento">
                            ...
                            <div className="cx-img">
                                <img className="pessoas" src="https://lh3.googleusercontent.com/a-/ALV-UjUfriJpzQ25yRrTF97oRYNQgCTS2mG8FJ-CnxEQxUsjYwo=w75-h75-p-rp-mo-br100" alt="foto" />
                                <h3>ose Candido Oliveira Silva</h3>
                            </div>
                    ...
                    <SwiperSlide>
                        <div className="box-depoimento">
                            ...
                            <div className="cx-img">
                                <img className="pessoas" src="https://lh3.googleusercontent.com/a-/ALV-UjX-0hTSTOqrADJKl_ALGsrMV38-fCk1gdCAujnjYye93Vg=w75-h75-p-rp-mo-br100" alt="foto" />
                                <h3>Júnia Borges</h3>
                            </div>
                            ...
                            <div className="texto">
                                <p>
                                    Fizemos a instalação do sistema fotovoltaico com o Sr. Fábio e ficamos impressionados com o atendimento.
                    ...
                    <SwiperSlide>
                        <div className="box-depoimento">
                            ...
                            <div className="cx-img">
                                <img className="pessoas" src="https://lh3.googleusercontent.com/a/ACg8ocKHpeLUZ44DDsSZLisfNUMsk7p5Lu0crm9rs-mEFadk=w75-h75-p-rp-mo-br100" alt="foto" />
                                <h3>Carlos Eduardo de Almeida Ribeiro</h3>
                            </div>
                    ...
                    <SwiperSlide>
                        <div className="box-depoimento">
                            ...
                            <div className="cx-img">
                                <img className="pessoas" src="https://lh3.googleusercontent.com/a/ACg8ocIpAFgUgRNp_FlUdrg1Q2Q4n0r7yS1E9dtFpR92akGH=w75-h75-p-rp-mo-br100" alt="foto" />
                                <h3>Fabiano Pardini</h3>
                            </div>
                    ...
                    <SwiperSlide>
                        <div className="box-depoimento">
                            ...
                            <div className="cx-img">
                                <img className="pessoas" src="https://lh3.googleusercontent.com/a-/ALV-UjWrkz6qFVcGcXtTfgix5897w7tZ5XYOcfq6LMWT7sti8Mk=w75-h75-p-rp-mo-br100" alt="foto" />
                                <h3>lesio Domiciano</h3>
                            </div>
                            ...
                            <div className="texto">
                                <p>
                                    AExcelente experiência com a Solar 4.0. Atendimento com muita competência, domínio técnico, funcionários treinados, capacitados e ótima conduta.
                    ...
                    <SwiperSlide>
                        <div className="box-depoimento">
                            ...
                            <div className="cx-img">
                                <img className="pessoas" src="https://lh3.googleusercontent.com/a/ACg8ocJaK6UIZKT2e93Gi1ADg-MS6ydtSlU2Hb4OQ9v5G6fh=w75-h75-p-rp-mo-br100" alt="foto" />
                                <h3>Denilson Ferreira da Silva</h3>
                            </div>
                    ...
                    <SwiperSlide>
                        <div className="box-depoimento">
                            ...
                            <div className="cx-img">
                                <img className="pessoas" src="https://lh3.googleusercontent.com/a-/ALV-UjVH1iipJlA6bYmMB-0RwjWD3K6HxhcF9yPXv-5aERimn2Q=w75-h75-p-rp-mo-br100" alt="foto" />
                                <h3>Heloiza Cançado</h3>
                            </div>
                    ...
                    <SwiperSlide>
                        <div className="box-depoimento">
                            ...
                            <div className="cx-img">
                                <img className="pessoas" src="https://lh3.googleusercontent.com/a/ACg8ocI6ywi0V03Drz-BVW-LoZtKiEXdvJ_H67FvA8GySsEw=w75-h75-p-rp-mo-br100" alt="foto" />
                                <h3>Bruno Godinho</h3>
                            </div>
                    ...
                    <SwiperSlide>
                        <div className="box-depoimento">
                            ...
                            <div className="cx-img">
                                <img className="pessoas" src="https://lh3.googleusercontent.com/a-/ALV-UjWsxHB5ZffItZXXfSj3Df3wKbBBiBqnOgh3yAbD3EG0hdA=w75-h75-p-rp-mo-br100" alt="foto" />
                                <h3>David Salgado</h3>
                            </div>
                    ...
                    <SwiperSlide>
                        <div className="box-depoimento">
                            ...
                            <div className="cx-img">
                                <img className="pessoas" src="https://lh3.googleusercontent.com/a/ACg8ocJt5-r21CeNtwbOODpW-rt6pyXoFb81TbLlaEdPNNCU=w75-h75-p-rp-mo-br100" alt="foto" />
                                <h3>Pedro Bastos Altomari</h3>
                            </div>
